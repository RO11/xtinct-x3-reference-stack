...
> **XTINCT fork checkout:** This working tree is the CrossPoint foundation plus
> an active, private XTINCT X3 fork. Read [`../../README.md`](../../README.md),
> [`../../docs/RECOVERY.md`](../../docs/RECOVERY.md), and
> [`docs/xtinct-daily-cards.md`](docs/xtinct-daily-cards.md) before building or
> flashing. Use the repository-owned pinned build wrapper documented there;
> do not treat the upstream upload instructions below as approval to flash the
> current dirty tree. Firmware packages are private candidates until their
> exact hash, recovery route, and required physical X3 acceptance checks are
> recorded.
