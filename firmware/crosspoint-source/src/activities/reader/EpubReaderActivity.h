...
class EpubReaderActivity final : public Activity {
  ...
  bool allocationFailurePending = false;
  ...
  // word vectors of heap strings. Allocation failures now unwind to the reader
  // transaction boundary, but the tick is deferrable work and should not churn
  ...
  // tick failed anyway. Free heap says how much memory exists; maxAlloc says whether
  ...
  // deserialization and glyph caching allocate; skip deferrable work below it
  // even though failures now unwind safely to the reader boundary.
  ...
  void handleAllocationFailure(const char* phase) noexcept;
  void onExitImpl();
 ...
 public:
  ...
  bool hasBookOwner() const noexcept { return static_cast<bool>(epub); }
  ...
  void onDeferredAllocationFailure(const char* phase) noexcept override {
