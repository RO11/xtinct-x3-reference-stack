...
#include "util/ButtonMenuLayout.h"
...
enum UIIcon { None = 0, Folder, Text, Image, Book, File, Recent, Settings, Transfer, Library, Wifi, Hotspot, Bookmark, Inbox, Cards };
...
class BaseTheme {
 public:
  ...
  virtual button_menu::Layout getButtonMenuLayout(const GfxRenderer& renderer, Rect rect, int buttonCount,
