...
class HalGPIO {
 ...
 public:
  ...
  // Immediate, non-debounced X3 hardware sample used only to decide whether
  // the slower boot-recovery detector should run. This keeps timer wakes fast
  // while still allowing recovery after panic/software resets.
  bool isBootRecoveryPowerUpHeldNow();
