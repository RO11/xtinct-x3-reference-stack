...
bool HalGPIO::isBootRecoveryPowerUpHeldNow() {
#if CROSSPOINT_EMULATED == 0
  if (!deviceIsX3() || BoardConfig::ACTIVE.inputStyle != BoardConfig::InputStyle::XteinkAdcLadder ||
  ...
  return group2.button == BTN_UP && digitalRead(BoardConfig::ACTIVE.input.power) == powerActiveLevel;
#else
  return false;
#endif
}
